...
(ert-deftest evil-test-forward-word-end ()
  ...
  (evil-test-buffer
    ...
    (ert-info ("Word")
      ...
      (evil-verify-around-point "\\`;; Thi°s buffer"))
    (ert-info ("With count")
      (execute-kbd-macro "3e")
      (evil-verify-around-point "\\`;; This buffer is fo°r"))
    (ert-info ("With count on whitespace")
      (backward-word)
      (backward-char)
      (evil-verify-around-point "buffer is° for")
      (execute-kbd-macro "2e")
      (evil-verify-around-point "is for note°s"))
    (ert-info ("Empty line")
      (execute-kbd-macro "47e")
      (evil-verify-around-point "buffer\\.\n°\nBelow"))
    (ert-info ("End of buffer")
      (execute-kbd-macro "1000e")
      (evil-verify-around-point "empty line°\\.")
...
(ert-deftest evil-test-forward-word-begin ()
  ...
  (evil-test-buffer
    (ert-info ("Simple")
      ...
      (evil-verify-around-point ";; °This"))
    (ert-info ("With count")
      (execute-kbd-macro "6w")
      (evil-verify-around-point "you °don"))
    (ert-info ("Non-word")
      (execute-kbd-macro "w")
      (evil-verify-around-point "don°'t")
      (execute-kbd-macro "11w")
      (evil-verify-around-point "evaluation.\n°;; If"))
    (ert-info ("On whitespace")
      (forward-word)
      (evil-verify-around-point ";; If° you")
      (execute-kbd-macro "2w")
      (evil-verify-around-point "evaluation.\n;; If you °want"))
    (ert-info ("Empty line")
      (execute-kbd-macro "30w")
      (evil-verify-around-point "buffer\\.\n°\nBelow"))
    (ert-info ("End of buffer")
      (execute-kbd-macro "1000w")
      (evil-verify-around-point "line°\\.")
...
(ert-deftest evil-test-backward-word-end ()
  ...
  (evil-test-buffer
    ...
    (ert-info ("Simple")
      (execute-kbd-macro "ge")
      (evil-verify-around-point "lin°e\\."))
    (ert-info ("With count")
      (execute-kbd-macro "2ge")
      (evil-verify-around-point "Below th°e empty"))
    (ert-info ("Empty line")
      (execute-kbd-macro "2ge")
      (evil-verify-around-point "buffer\\.\n°\nBelow"))
    (ert-info ("With count on whitespace")
...
(ert-deftest evil-test-backward-word-begin ()
  ...
  (evil-test-buffer
    ...
    (ert-info ("Simple")
      ...
      (evil-verify-around-point "°line\\."))
    (ert-info ("With count")
      (execute-kbd-macro "2b")
      (evil-verify-around-point "Below °the empty"))
    (ert-info ("Empty line")
      (execute-kbd-macro "2b")
      (evil-verify-around-point "buffer\\.\n°\nBelow"))
    (ert-info ("With count on whitespace")
      ...
      (backward-char)
      (evil-verify-around-point "own° buffer")
      (execute-kbd-macro "4b")
      (evil-verify-around-point "°file's own"))
    (ert-info ("Beginning of buffer")
      (execute-kbd-macro "1000b")
      (evil-verify-around-point "\\`°;; This")
