...
(eval-after-load 'dired
  '(progn
     ...
     (let ((map dired-mode-map))
       (evil-define-key 'normal map "j" 'evil-next-line)
       (evil-define-key 'normal map "k" 'evil-previous-line)
       (evil-define-key 'normal map "l" 'evil-forward-char)
       (evil-define-key 'normal map "h" 'evil-backward-char)
       (evil-define-key 'normal map ":" 'evil-ex)

       (evil-define-key 'normal map [mouse-2] 'dired-mouse-find-file-other-window)
       (evil-define-key 'normal map [follow-link] 'mouse-face)
       ;; Commands to mark or flag certain categories of files
       (evil-define-key 'normal map "#" 'dired-flag-auto-save-files)
       (evil-define-key 'normal map "." 'dired-clean-directory)
       (evil-define-key 'normal map "~" 'dired-flag-backup-files)
       ;; Upper case keys (except !) for operating on the marked files
       (evil-define-key 'normal map "A" 'dired-do-find-regexp)
       (evil-define-key 'normal map "C" 'dired-do-copy)
       (evil-define-key 'normal map "B" 'dired-do-byte-compile)
       (evil-define-key 'normal map "D" 'dired-do-delete)
       (evil-define-key 'normal map "G" 'dired-do-chgrp)
       (evil-define-key 'normal map "H" 'dired-do-hardlink)
       (evil-define-key 'normal map "L" 'dired-do-load)
       (evil-define-key 'normal map "M" 'dired-do-chmod)
       (evil-define-key 'normal map "O" 'dired-do-chown)
       (evil-define-key 'normal map "P" 'dired-do-print)
       (evil-define-key 'normal map "Q" 'dired-do-find-regexp-and-replace)
       (evil-define-key 'normal map "R" 'dired-do-rename)
       (evil-define-key 'normal map "S" 'dired-do-symlink)
       (evil-define-key 'normal map "T" 'dired-do-touch)
       (evil-define-key 'normal map "X" 'dired-do-shell-command)
       (evil-define-key 'normal map "Z" 'dired-do-compress)
       (evil-define-key 'normal map "c" 'dired-do-compress-to)
       (evil-define-key 'normal map "!" 'dired-do-shell-command)
       (evil-define-key 'normal map "&" 'dired-do-async-shell-command)
       ;; Comparison commands
       (evil-define-key 'normal map "=" 'dired-diff)
       ;; Tree Dired commands
       (evil-define-key 'normal map "\M-\C-?" 'dired-unmark-all-files)
       (evil-define-key 'normal map "\M-\C-d" 'dired-tree-down)
       (evil-define-key 'normal map "\M-\C-u" 'dired-tree-up)
       (evil-define-key 'normal map "\M-\C-n" 'dired-next-subdir)
       (evil-define-key 'normal map "\M-\C-p" 'dired-prev-subdir)
       ;; move to marked files
       (evil-define-key 'normal map "\M-{" 'dired-prev-marked-file)
       (evil-define-key 'normal map "\M-}" 'dired-next-marked-file)
       ;; Make all regexp commands share a `%' prefix:
       ;; We used to get to the submap via a symbol dired-regexp-prefix,
       ;; but that seems to serve little purpose, and copy-keymap
       ;; does a better job without it.
       (evil-define-key 'normal map "%" nil)
       (evil-define-key 'normal map "%u" 'dired-upcase)
       (evil-define-key 'normal map "%l" 'dired-downcase)
       (evil-define-key 'normal map "%d" 'dired-flag-files-regexp)
       (evil-define-key 'normal map "%g" 'dired-mark-files-containing-regexp)
       (evil-define-key 'normal map "%m" 'dired-mark-files-regexp)
       (evil-define-key 'normal map "%r" 'dired-do-rename-regexp)
       (evil-define-key 'normal map "%C" 'dired-do-copy-regexp)
       (evil-define-key 'normal map "%H" 'dired-do-hardlink-regexp)
       (evil-define-key 'normal map "%R" 'dired-do-rename-regexp)
       (evil-define-key 'normal map "%S" 'dired-do-symlink-regexp)
       (evil-define-key 'normal map "%&" 'dired-flag-garbage-files)
       ;; Commands for marking and unmarking.
       (evil-define-key 'normal map "*" nil)
       (evil-define-key 'normal map "**" 'dired-mark-executables)
       (evil-define-key 'normal map "*/" 'dired-mark-directories)
       (evil-define-key 'normal map "*@" 'dired-mark-symlinks)
       (evil-define-key 'normal map "*%" 'dired-mark-files-regexp)
       (evil-define-key 'normal map "*c" 'dired-change-marks)
       (evil-define-key 'normal map "*s" 'dired-mark-subdir-files)
       (evil-define-key 'normal map "*m" 'dired-mark)
       (evil-define-key 'normal map "*u" 'dired-unmark)
       (evil-define-key 'normal map "*?" 'dired-unmark-all-files)
       (evil-define-key 'normal map "*!" 'dired-unmark-all-marks)
       (evil-define-key 'normal map "U" 'dired-unmark-all-marks)
       (evil-define-key 'normal map "*\177" 'dired-unmark-backward)
       (evil-define-key 'normal map "*\C-n" 'dired-next-marked-file)
       (evil-define-key 'normal map "*\C-p" 'dired-prev-marked-file)
       (evil-define-key 'normal map "*t" 'dired-toggle-marks)
       ;; Lower keys for commands not operating on all the marked files
       (evil-define-key 'normal map "a" 'dired-find-alternate-file)
       (evil-define-key 'normal map "d" 'dired-flag-file-deletion)
       (evil-define-key 'normal map "e" 'dired-find-file)
       (evil-define-key 'normal map "f" 'dired-find-file)
       (evil-define-key 'normal map "\C-m" 'dired-find-file)
       (evil-define-key 'normal map "g" 'revert-buffer)
       (evil-define-key 'normal map "i" 'dired-maybe-insert-subdir)
       (evil-define-key 'normal map "J" 'dired-goto-file)
       (evil-define-key 'normal map "K" 'dired-do-kill-lines)
       (evil-define-key 'normal map "r" 'dired-do-redisplay)
       (evil-define-key 'normal map "m" 'dired-mark)
       (evil-define-key 'normal map "n" 'dired-next-line)
       (evil-define-key 'normal map "o" 'dired-find-file-other-window)
       (evil-define-key 'normal map "\C-o" 'dired-display-file)
       (evil-define-key 'normal map "p" 'dired-previous-line)
       (evil-define-key 'normal map "s" 'dired-sort-toggle-or-edit)
       (evil-define-key 'normal map "t" 'dired-toggle-marks)
       (evil-define-key 'normal map "u" 'dired-unmark)
       (evil-define-key 'normal map "v" 'dired-view-file)
       (evil-define-key 'normal map "w" 'dired-copy-filename-as-kill)
       (evil-define-key 'normal map "W" 'browse-url-of-dired-file)
       (evil-define-key 'normal map "x" 'dired-do-flagged-delete)
       (evil-define-key 'normal map "y" 'dired-show-file-type)
       (evil-define-key 'normal map "+" 'dired-create-directory)
       ;; moving
       (evil-define-key 'normal map "<" 'dired-prev-dirline)
       (evil-define-key 'normal map ">" 'dired-next-dirline)
       (evil-define-key 'normal map "^" 'dired-up-directory)
       (evil-define-key 'normal map " " 'dired-next-line)
       (evil-define-key 'normal map [?\S-\ ] 'dired-previous-line)
       (evil-define-key 'normal map [remap next-line] 'dired-next-line)
       (evil-define-key 'normal map [remap previous-line] 'dired-previous-line)
       ;; hiding
       (evil-define-key 'normal map "$" 'dired-hide-subdir)
       (evil-define-key 'normal map "\M-$" 'dired-hide-all)
       (evil-define-key 'normal map "(" 'dired-hide-details-mode)
       ;; isearch
       (evil-define-key 'normal map (kbd "M-s a C-s")   'dired-do-isearch)
       (evil-define-key 'normal map (kbd "M-s a M-C-s") 'dired-do-isearch-regexp)
       (evil-define-key 'normal map (kbd "M-s f C-s")   'dired-isearch-filenames)
       (evil-define-key 'normal map (kbd "M-s f M-C-s") 'dired-isearch-filenames-regexp)
       ;; misc
       (evil-define-key 'normal map [remap read-only-mode] 'dired-toggle-read-only)
       ;; `toggle-read-only' is an obsolete alias for `read-only-mode'
       (evil-define-key 'normal map [remap toggle-read-only] 'dired-toggle-read-only)
       (evil-define-key 'normal map "?" 'dired-summary)
       (evil-define-key 'normal map "\177" 'dired-unmark-backward)
       (evil-define-key 'normal map [remap undo] 'dired-undo)
       (evil-define-key 'normal map [remap advertised-undo] 'dired-undo)
       ;; thumbnail manipulation (image-dired)
       (evil-define-key 'normal map "\C-td" 'image-dired-display-thumbs)
       (evil-define-key 'normal map "\C-tt" 'image-dired-tag-files)
       (evil-define-key 'normal map "\C-tr" 'image-dired-delete-tag)
       (evil-define-key 'normal map "\C-tj" 'image-dired-jump-thumbnail-buffer)
       (evil-define-key 'normal map "\C-ti" 'image-dired-dired-display-image)
       (evil-define-key 'normal map "\C-tx" 'image-dired-dired-display-external)
       (evil-define-key 'normal map "\C-ta" 'image-dired-display-thumbs-append)
       (evil-define-key 'normal map "\C-t." 'image-dired-display-thumb)
       (evil-define-key 'normal map "\C-tc" 'image-dired-dired-comment-files)
       (evil-define-key 'normal map "\C-tf" 'image-dired-mark-tagged-files)
       (evil-define-key 'normal map "\C-t\C-t" 'image-dired-dired-toggle-marked-thumbs)
       (evil-define-key 'normal map "\C-te" 'image-dired-dired-edit-comment-and-tags)
       ;; encryption and decryption (epa-dired)
       (evil-define-key 'normal map ";d" 'epa-dired-do-decrypt)
       (evil-define-key 'normal map ";v" 'epa-dired-do-verify)
       (evil-define-key 'normal map ";s" 'epa-dired-do-sign)
       (evil-define-key 'normal map ";e" 'epa-dired-do-encrypt))))
